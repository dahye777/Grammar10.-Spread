...
// 정말 잘 적용되었는지를 확인하려면
num1 = "211515";
// num1을 재정의하고 콘솔을 찍어보면 num1만 바뀌어 있는 것을 확인할 수 있습니다
// 이로 미루어보아 num2는 완전한 복사가 이루어진 것으로 알 수 있습니다
console.log(num1);
console.log(num2);
...
참조형의 자료는 주소의 값만 복사되기 때문에 변하면 복사된 값도 변하게 딥니다

따라서 다른 복사 방법이 필요합니다

중요!!
불변성 : 기존 자료가 복사, 변형, 이동 등의 변화가 있을 때 변화 이전과 변화 이후의 자료가
서로 영향을 미치지 않는 성질(독립적인 개체가 되어야한다는 의미)
...
패키징으로부터 꺼내 펼쳐 놓음을 의미합니다. 하지만 전개연산자 자체로는 값을 바로 사용할 수 
있는 형태는 아니고, 새롭게 옮겨 담을 패키징을 한 뒤에 사용할 수 있습니다
*/

console.log(arr1);
console.log(...arr1);

//전개연산자로 객체값을 추가할 수 있습니다
const obj = {
  name: "David",
  age: 20,
};
